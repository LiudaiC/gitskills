...
spa.fake = (function(){
	...
	peopleList = [
		   {  name : 'Betty', _id : 'id_01',
			  css_map : {
				  top : 20, let : 20, 'background-color' : 'rgb(128, 128, 128)'
			  }
		   },
		   {  name : 'Mike', _id : 'id_02',
			  css_map : {
				  top : 60, let : 60, 'background-color' : 'rgb(128, 255, 128)'
			  }
		   },
		   {  name : 'Pebless', _id : 'id_03',
			  css_map : {
				  top : 100, let : 100, 'background-color' : 'rgb(128, 192, 192)'
			  }
		   },
		   {  name : 'Wilma', _id : 'id_04',
			  css_map : {
				  top : 140, let : 140, 'background-color' : 'rgb(192, 128, 128)'
			  }
		   }
		];
